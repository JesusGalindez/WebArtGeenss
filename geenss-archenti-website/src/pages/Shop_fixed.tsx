...
const Shop = () => {
  ...
  const handleAddToCart = (product: Product, type: 'original' | 'print') => {
    if (type === 'original' && !product.originalAvailable) {
      toast.error('Esta obra original no está disponible');
      return;
    }
    ...
    addToCart({
      ...
      price: type === 'original' ? product.originalPrice : product.printPrice,
      image: product.image,
      quantity: 1
    });
        ...
        {showCart && (
          ...
          >
            <motion.div
              ...
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
              className="absolute right-0 top-0 h-full w-full max-w-md bg-white border-gray-200"
              ...
              <div className="text-center">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-gray-200 hover:bg-gray-300 text-gray-900 py-3 px-6 rounded-lg font-semibold transition-colors"
                  >
                    Cancelar
                  </button>
                </div>
