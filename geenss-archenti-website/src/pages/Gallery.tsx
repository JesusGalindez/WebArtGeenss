  ...
  return (
    <div className="min-h-screen py-8 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex flex-wrap gap-2 sm:gap-1 rounded-lg p-1 bg-white shadow-lg max-w-full">
            <button
              onClick={() => setSelectedGalleryYear(null)}
              className={`px-3 sm:px-6 py-2 sm:py-3 rounded-md font-medium transition-all text-sm sm:text-base min-h-[44px] ${
                !selectedGalleryYear
          ...
          <AnimatePresence>
            {filteredArtworks.map((artwork, index) => (
              <motion.div
                ...
                className="group cursor-pointer bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300"
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    onClick={() => setSelectedArtwork(artwork)}
                    className="mt-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-2 rounded-lg font-medium hover:shadow-lg active:scale-95 transition-all duration-300 min-h-[44px] w-full sm:w-auto"
                  >
                    Ver Detalles
                  </button>
                </div>
        ...
        {selectedArtwork && (
          ...
          >
            <motion.div
              ...
              className="max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-white shadow-2xl m-0 sm:m-4"
            >
              <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 p-4 sm:p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      onClick={() => setSelectedArtwork(null)}
                      className="p-3 sm:p-2 rounded-lg transition-colors hover:bg-gray-100 active:bg-gray-200 min-w-[44px] min-h-[44px] flex items-center justify-center flex-shrink-0"
                      aria-label="Cerrar"
                    >
                      <X size={24} />
                    </button>
